...
<!-- initialized-at: 2026-08-27 02:24:09 +08:00 -->

# Codex Git Workflow

Initialization status: initialized
Project: LearnProverbs
Repository root: D:\WebProjects\LearnProverbs
Machine config: `
...
```
powershell
git -c safe.directory=D:/WebProjects/LearnProverbs status --short --branch
```
...
```
powershell
git -c safe.directory=D:/WebProjects/LearnProverbs push -u origin HEAD
```
