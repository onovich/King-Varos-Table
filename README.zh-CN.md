...
版本 `0.4.0` 已形成可在本地游玩的战役切片。本次更新实际验证了英文、简体中文以及桌面、768px、320px 三种宽度，并完整走通“序章教学—逐关解锁—正式地图”流程；浏览器控制台没有报错，36 项自动化测试全部通过。

项目目前没有公开托管的在线试玩地址。更多章节、最终美术、正式平衡以及完整的纯键盘和触屏操作仍待制作。
