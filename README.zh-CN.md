...
版本 `0.6.0` 已形成支持鼠标、触屏、键盘和 100 步会话历史的本地战役切片。撤销／重做已经实测普通落笔、分叉后的重做失效、教学页完成、国家陷落与故事归档；320px 布局没有页面级横向溢出，浏览器控制台无报错，42 项自动化测试全部通过。

项目目前没有公开托管的在线试玩地址。更多章节、最终美术、正式平衡与拖动涂色仍待制作。
