...
export async function addScannedFood(scene){
 ...
 const names=['food_apple_01','food_pomegranate_01','croissant'];
 const assets=await Promise.all(names.map(name=>loader.loadAsync(`./assets/${name}/model.gltf`)));
 ...
 for(const [x,z,a] of [[-4.75,-5.8,.2],[-4.75,5.8,1.3],[4.75,0,-.4],[0,-7.8,.8]])place('croissant',x,3.115,z,1.35,a);
